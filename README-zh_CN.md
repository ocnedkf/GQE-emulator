...
<br>
```bash
curl -s -o g https://gh-proxy.org/https://raw.githubusercontent.com/ocnedkf/GQE-emulator/refs/heads/v0.2-beta/zh_CN/install-zh-sh && chmod +x g && ./g
```
...
<br>
```bash
curl -s -o u https://gh-proxy.org/https://raw.githubusercontent.com/ocnedkf/GQE-emulator/refs/heads/v0.2-beta/zh_CN/uninstall-gqe && chmod +x u && ./u
```
