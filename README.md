...
GQE is an emulator that runs Windows x86_64 programs on Android ARM64 devices, no root, relying on [Termux](https://github.com/termux/termux-app), Termux-x11, and [InputBridge](https://inputbridge.net/)
<br>
